...
import { View ,Text, TextInput,StyleSheet,Image, Button ,TouchableOpacity, ImageBackground} from 'react-native';
...
{/* ////////////Todo/////////// */}
<ImageBackground  style={{height:'100%'}}   source={{uri:'https://www.css-gradient.com/imgs/twitter-card.png'}}>
<Text style={{color:"white",fontWeight:"bold",fontSize:32,textAlign:"center",marginTop:50}} >Todo App</Text> 
<View style={styles.bhai}>
<TextInput style={styles.input4} placeholder='Enter Value' />
